const zh = {
  ...
  officialApps: "CH TECH GIANT 官方应用",

  heroTitle1: "下载我们的",
  heroTitle2: "Android 应用",

  heroDescription:
    "探索由 CH TECH GIANT 开发的高品质生产力、PDF、商业、教育和实用工具应用程序。",
  ...
  ourAppsDesc:
    "直接从 Google Play 下载我们最新的 Android 应用程序，或安装官方 APK。",
  ...
  noAppsDesc: "请尝试使用其他关键词搜索。",

  moreApps: "更多应用即将推出 🚀",

  moreAppsDesc:
    "我们持续开发强大的 Android 应用程序、生产力工具、商业软件和实用工具应用。",
  ...
  homeHeroTitle2: "数字解决方案",

  homeHeroDescription:
    "我们为初创企业、中小企业和大型企业打造高端网站、移动应用、软件系统、创意设计以及可扩展的数字解决方案。",
  ...
  ourExpertise: "我们的专业领域",

  servicesWeProvide: "我们提供的服务",

  services: {
    webDevelopment: {
      title: "网站开发",
      description: "现代响应式网站和可扩展的 Web 应用程序。",
    },

    appDevelopment: {
      title: "应用开发",
      description: "为企业提供高端 Android 和 iOS 移动应用解决方案。",
    },

    softwareDevelopment: {
      title: "软件开发",
      description: "定制软件系统和企业级解决方案。",
    },

    gameDevelopment: {
      title: "游戏开发",
      description: "互动式 2D 和 3D 游戏开发体验。",
    },
  },
  ...
  technologiesWeUse: "我们使用的技术",

  // Latest Apps

  latestApps: "最新应用",

  publishedPlayStoreApps: "已发布到 Play Store 的应用",
  ...
  latestAppsData: {
    fileConverter: {
      title: "文件转换器",
      description:
        "一体化文件转换工具包，提供 PDF、图像、音频、视频和文本转换工具。",
    },

    fileRenamer: {
      title: "文件重命名器",
      description:
        "批量文件重命名和文件清理工具，配备现代自动化功能。",
    },

    webCodshop: {
      title: "Web Codshop",
      description:
        "提供高端网站模板、源代码以及带有报告的大学项目的 Marketplace 应用。",
    },
  },
  ...
  servicesDescription:
    "CH TECH GIANT 为企业提供高端软件解决方案、现代应用程序、未来感网站以及可扩展的数字体验。",

  serviceData: {
    appDevelopment: {
      title: "应用开发",
      description:
        "使用高端 UI 和流畅性能进行 Android 及跨平台移动应用开发。",
    },

    softwareDevelopment: {
      title: "软件开发",
      description: "定制桌面软件和企业软件开发解决方案。",
    },
    ...
    gameDevelopment: {
      title: "游戏开发",
      description: "具有沉浸式游戏体验的互动式 2D 和 3D 游戏开发。",
    },

    itConsulting: {
      title: "IT 咨询",
      description: "专业技术咨询和企业数字化转型解决方案。",
    },

    pamphletDesign: {
      title: "宣传册设计",
      description: "采用高端模板打造现代未来感宣传册和传单。",
    },

    invoiceDesign: {
      title: "发票设计",
      description: "采用高端设计打造现代未来感发票模板。",
    },
  },
  ...
  appDevelopment: {
    ...
    pageSubtitle:
      "为初创企业、企业和大型组织开发可扩展的 Android、iOS 和 Flutter 应用程序。",

    // =========================
    // HERO
    // =========================

    heroTitle: "定制移动应用开发公司",

    heroDescription1:
      "CH TECH GIANT 专注于创建强大的移动应用程序，帮助企业发展、吸引客户、优化运营并创造收入。我们的团队开发现代 Android、iOS 和 Flutter 应用程序，并根据您的独特业务需求进行定制。",

    heroDescription2:
      "无论您是准备推出初创企业 MVP、构建企业级平台，还是升级现有应用程序，我们的专家都能提供安全、可扩展且高性能的移动解决方案。",
    ...
    servicesTitle: "我们的应用开发服务",

    servicesDescription:
      "为初创企业、中小企业和大型企业提供端到端的移动应用开发解决方案。",

    services: [
      {
        title: "Android 应用开发",
        description:
          "使用现代技术为初创企业、企业和大型组织打造定制 Android 应用程序。",
      },
      {
        title: "iOS 应用开发",
        description:
          "打造针对性能、安全性和用户体验进行优化的高端 iPhone 和 iPad 应用程序。",
      },
      {
        title: "Flutter 应用开发",
        description:
          "使用单一代码库开发 Android 和 iOS 移动应用，实现更快的开发速度和更低的成本。",
      },
      {
        title: "企业移动应用",
        description:
          "采用现代技术和可扩展架构提供专业的 React Native 解决方案。",
      },
      {
        title: "应用 UI/UX 设计",
        description:
          "打造现代化界面和流畅的用户体验，提高用户参与度和留存率。",
      },
      {
        title: "维护与支持",
        description:
    ...
    mobileAppsTitle: "我们开发的移动应用",

    mobileAppsDescription:
      "我们根据不同的行业和商业模式打造强大的移动应用程序。从初创企业到大型企业，我们经验丰富的开发人员创建安全、可扩展且功能丰富的移动解决方案，帮助企业提高客户参与度、优化运营并推动业务增长。",
    ...
    appCategories: [
      {
        ...
        title: "Android 应用开发",
        description:
          "为初创企业、中小企业和大型企业打造强大、可扩展且功能丰富的 Android 应用程序。我们开发高性能 Android 应用。",
        features: [
          "Android 开发",
          "Material UI 设计",
          "Google API 集成",
      ...
      },
      {
        ...
        title: "iOS 应用开发",
        description:
          "打造速度快、安全且具有出色用户体验的高端 iPhone 和 iPad 应用程序。我们的 iOS 应用针对各种 Apple 设备进行了优化。",
        features: [
          "Swift 开发",
          "Apple 指南",
          "App Store 发布",
      ...
      },
      {
        ...
        title: "Flutter 应用开发",
        description:
          "使用单一 Flutter 代码库开发 Android 和 iOS 应用，在降低开发成本的同时保持出色的性能。",
        features: [
          "单一代码库",
          "跨平台",
          "快速开发",
      ...
      },
      {
        ...
        title: "约会应用开发",
        description:
          "创建现代约会应用，提供智能匹配、基于位置的发现、安全消息、语音和视频通话以及高级订阅功能。",
        features: [
          "位置匹配",
          "滑动匹配系统",
          "私密聊天",
      ...
      },
      {
        ...
        title: "电子商务应用开发",
        description:
          "推出功能丰富的在线购物应用，提供安全支付网关、库存管理、客户分析和订单跟踪。",
        features: [
          "产品目录",
          "购物车",
          "安全支付",
      ...
      },
      {
        ...
        title: "购物应用开发",
        description:
          "通过个性化推荐、忠诚度计划、多种支付方式和流畅结账体验提供更具吸引力的购物体验。",
        features: [
          "产品搜索",
          "折扣优惠券",
          "支付网关",
      ...
      {
        id: 7,
        title: "Marketplace 应用开发",
        description:
          "开发连接买家和卖家的多供应商 Marketplace 应用，提供安全交易、供应商后台和佣金管理。",
        features: [
          "供应商后台",
          "佣金系统",
          "买家后台",
      ...
      },
      {
        ...
        title: "外卖应用开发",
        description:
          "为餐厅、云厨房和聚合平台打造外卖解决方案，提供实时跟踪、在线支付和客户互动功能。",
        features: [
          "餐厅列表",
          "实时跟踪",
          "在线支付",
      ...
      },
      {
        ...
        title: "餐厅应用开发",
        description:
          "为餐厅打造数字化应用，支持在线点餐、预订、菜单管理、会员忠诚度计划和客户关系管理。",
        features: [
          "数字菜单",
          "餐桌预订",
          "在线点餐",
      ...
      },
      {
        ...
        title: "杂货配送应用开发",
        description:
          "打造智能杂货配送应用，提供库存管理、即时订购、预约配送和安全支付解决方案。",
        features: [
          "产品分类",
          "配送时间安排",
          "多种支付方式",
      ...
      },
      {
        ...
        title: "医疗应用开发",
        description:
          "开发安全的医疗应用，通过数字医疗解决方案、在线咨询、处方和健康监测帮助医疗服务提供者改善患者护理。",
        features: [
          "医生咨询",
          "电子处方",
          "患者记录",
      ...
      },
      {
        ...
        title: "医院管理应用",
        description:
          "为诊所和医疗机构提供综合医院管理应用，包括预约、计费、患者管理和医疗记录系统。",
        features: [
          "患者管理",
          "医生后台",
          "计费系统",
      ...
      },
      {
        ...
        title: "药房应用开发",
        description:
          "在线药房应用允许客户订购药品、上传处方、安排配送并接收用药提醒。",
        features: [
          "药品目录",
          "处方上传",
          "在线支付",
      ...
      },
      {
        ...
        title: "健身与健康应用",
        description:
          "打造具有锻炼跟踪、营养计划、可穿戴设备集成、进度分析和健康监测功能的健身应用。",
        features: [
          "锻炼计划",
          "饮食跟踪",
          "BMI 计算器",
      ...
      },
      {
        ...
        title: "教育应用开发",
        description:
          "为学校、大学、培训机构和在线学习平台打造互动教育应用，提供丰富的数字学习体验。",
        features: [
          "视频课程",
          "在线直播课程",
          "测验",
      ...
      },
      {
        ...
        title: "学习管理系统",
        description:
          "强大的学习管理系统（LMS），帮助组织提供在线课程、评估、认证和学习者数据分析。",
        features: [
          "课程管理",
          "学生跟踪",
          "在线考试",
      ...
      },
      {
        ...
        title: "学校 ERP 应用",
        description:
          "端到端学校 ERP 解决方案，可自动化招生、考勤、费用管理、考试、沟通和学术报告。",
        features: [
          "考勤",
          "费用管理",
          "考试模块",
      ...
      },
      {
        ...
        title: "旅游应用开发",
        description:
          "开发旅游应用，支持机票、酒店、旅游套餐、行程和旅行体验预订，并提供 GPS 导航和数字支付。",
        features: [
          "机票预订",
          "酒店预订",
          "行程规划",
      ...
      },
      {
        ...
        title: "酒店与度假村应用",
        description:
          "现代酒店和度假村预订应用，提供客房预订、数字入住、宾客服务、在线支付和忠诚度计划。",
        features: [
          "客房预订",
          "可用性日历",
          "宾客入住",
      ...
      },
      {
        ...
        title: "出租车预订应用",
        description:
          "打造出租车和网约车应用，提供实时 GPS 跟踪、费用估算、司机管理、安全支付和行程历史。",
        features: [
          "司机后台",
          "乘客应用",
          "GPS 跟踪",
      ...
      },
      {
        ...
        title: "社交网络应用",
        description:
          "打造互动社交网络应用，通过帖子、故事、消息、社区和实时互动连接用户。",
        features: [
          "用户资料",
          "动态消息",
          "故事",
      ...
      },
      {
        ...
        title: "社区应用开发",
        description:
          "打造在线社区应用，让用户安全地建立联系、讨论话题、组织活动和分享知识。",
        features: [
          "讨论论坛",
          "群组",
          "活动",
      ...
      },
      {
        ...
        title: "视频流媒体应用",
        description:
          "推出 OTT 和视频流媒体平台，支持高清视频、订阅、推荐、观看列表和多设备访问。",
        features: [
          "高清视频",
          "观看列表",
          "订阅计划",
      ...
      },
      {
        ...
        title: "音乐流媒体应用",
        description:
          "开发音乐流媒体应用，提供播放列表、播客、离线下载、推荐和高级会员功能。",
        features: [
          "音乐库",
          "播放列表",
          "离线模式",
      ...
      },
      {
        ...
        title: "新闻与杂志应用",
        description:
          "创建数字新闻和杂志应用，提供实时更新、个性化信息流、离线阅读、书签和推送通知。",
        features: [
          "突发新闻",
          "分类",
          "离线阅读",
      ...
      },
      {
        ...
        title: "体育应用开发",
        description:
          "开发体育应用，提供实时比分、比赛日程、球员统计、梦幻联赛和球迷互动功能。",
        features: [
          "实时比分",
          "赛程",
          "球员统计",
      ...
      },
      {
        ...
        title: "活动与会议应用",
        description:
          "开发活动和会议管理应用，支持报名、票务、实时日程、社交交流和参会者互动。",
        features: [
          "活动报名",
          "票务预订",
          "日程管理",
      ...
      },
      {
        ...
        title: "招聘门户应用开发",
        description:
          "开发现代招聘平台，通过 AI 匹配、简历管理和面试安排连接雇主和求职者。",
        features: [
          "职位列表",
          "简历上传",
          "雇主后台",
      ...
      },
      {
        ...
        title: "房地产应用开发",
        description:
          "房地产信息应用，提供高级搜索、虚拟看房、经纪人管理、房贷计算器和预约功能。",
        features: [
          "房产列表",
          "虚拟看房",
          "地图搜索",
      ...
      },
      {
        ...
        title: "CRM 应用",
        description:
          "客户关系管理应用，用于优化销售、客户互动、潜在客户跟踪和业务增长。",
        features: [
          "潜在客户管理",
          "销售流程",
          "客户数据库",
      ...
      },
      {
        ...
        title: "ERP 应用",
        description:
          "企业资源规划应用，将财务、人力资源、库存、运营和报告整合到一个平台中。",
        features: [
          "人力资源管理",
          "库存",
          "财务",
      ...
      },
      {
        ...
        title: "云端应用",
        description:
          "基于云原生技术的应用程序，提供安全数据存储、实时同步、可扩展性和高可用性。",
        features: [
          "云存储",
          "实时同步",
          "备份",
      ...
      },
      {
        ...
        title: "GPS 与地理围栏应用",
        description:
          "利用 GPS 跟踪、地理围栏、实时导航和位置分析打造面向企业的位置感知应用。",
        features: [
          "实时 GPS",
          "地理围栏",
          "路线跟踪",
      ...
      },
      {
        ...
        title: "目录应用开发",
        description:
          "商业目录应用，用于组织企业、服务和联系方式，并提供搜索和筛选功能。",
        features: [
          "企业列表",
          "搜索",
          "分类",
      ...
      },
      {
        ...
        title: "实用工具应用开发",
        description:
          "实用工具应用，用于简化日常任务、提高生产力、管理文件、转换文件和优化设备。",
        features: [
          "工具",
          "文件管理",
          "离线支持",
      ...
      },
      {
        ...
        title: "生活方式应用开发",
        description:
          "涵盖时尚、美容、美食、旅行、健康、购物和个性化推荐的生活方式应用。",
        features: [
          "推荐",
          "愿望清单",
          "通知",
      ...
      },
      {
        ...
        title: "按需服务应用",
        description:
          "为家庭服务、美容、维修、医疗和其他即时预约业务开发按需服务应用。",
        features: [
          "即时预订",
          "服务提供商后台",
          "实时跟踪",
      ...
      },
      {
        ...
        title: "企业移动应用",
        description:
          "为大型组织设计企业级移动应用，提供安全工作流程、系统集成和基于角色的访问控制。",
        features: [
          "角色管理",
          "SSO 登录",
          "工作流程自动化",
      ...
      },
      {
        ...
        title: "推送通知解决方案",
        description:
          "通过智能推送通知系统提高用户参与度，支持用户分组、自动化和数据分析。",
        features: [
          "即时提醒",
          "用户分组",
          "自动化",
      ...
      },
      {
        ...
        title: "反馈与调查应用",
        description:
          "通过调查和反馈应用收集有价值的客户洞察，并提供分析、表单和报告仪表板。",
        features: [
          "自定义表单",
          "调查构建器",
          "数据分析",
      ...
      },
      {
        ...
        title: "初创企业 MVP 开发",
        description:
          "通过快速开发、可扩展架构和面向市场的解决方案，将创新想法转化为最小可行产品（MVP）。",
        features: [
          "快速开发",
          "可扩展设计",
          "云就绪",
      ...
      },
      {
        ...
        title: "AI 智能应用",
        description:
          "使用机器学习、自然语言处理、计算机视觉和预测分析开发智能 AI 移动应用，以自动化业务流程并改善用户体验。",
        features: [
          "人工智能",
          "机器学习",
          "预测分析",
      ...
      },
      {
        ...
        title: "聊天机器人应用",
        description:
          "构建 AI 聊天机器人应用，为客户提供即时支持、自动化对话、获取潜在客户并提高客户参与度。",
        features: [
          "AI 聊天机器人",
          "全天候支持",
          "潜在客户获取",
      ...
      },
      {
        ...
        title: "库存管理应用",
        description:
          "库存管理应用，用于简化库存控制、条码扫描、仓库运营、供应商管理和报告。",
        features: [
          "库存管理",
          "条码扫描器",
          "采购订单",
      ...
      },
      {
        ...
        title: "快递配送应用",
        description:
          "快递管理应用，支持包裹预订、货件跟踪、配送安排、送达证明和客户通知。",
        features: [
          "包裹预订",
          "货件跟踪",
          "配送员应用",
      ...
      },
      {
        ...
        title: "美容院与水疗应用",
        description:
          "为美容院、水疗中心和健康中心开发预约应用，提供员工排班、在线支付和会员忠诚度计划。",
        features: [
          "预约",
          "员工排班",
          "在线支付",
      ...
      },
      {
        ...
        title: "预约应用",
        description:
          "为医生、顾问、服务提供商和企业开发预约调度应用，并支持日历集成。",
        features: [
          "日历",
          "预订",
          "提醒",
      ...
      },
      {
        ...
        title: "农业应用",
        description:
          "农业应用帮助农民进行作物管理、天气预报、市场价格查询、灌溉监测和农场数据分析。",
        features: [
          "天气更新",
          "作物监测",
          "市场价格",
      ...
      },
      {
        ...
        title: "制造业应用",
        description:
          "制造业应用，用于生产计划、质量控制、员工管理、维护安排和运营效率提升。",
        features: [
          "生产计划",
          "质量控制",
          "维护管理",
      ...
      },
      {
        ...
        title: "预订与预约应用",
        description:
          "为酒店、旅游、活动、医疗、体育和服务提供商开发预订应用，支持实时可用性和在线支付。",
        features: [
          "在线预订",
          "可用性",
          "支付",
      ...
      },
      {
        ...
        title: "业务自动化应用",
        description:
          "业务自动化应用，用于优化工作流程、审批、文档管理、沟通和报告。",
        features: [
          "工作流程自动化",
          "文档管理",
          "审批",
      ...
      },
      {
        ...
        title: "定制移动应用",
        description:
          "需要独特的解决方案？我们根据您的业务目标、目标受众和行业需求，设计并开发完全定制的移动应用程序。",
        features: [
          "100% 定制",
          "UI/UX 设计",
          "后端开发",
    ...
    industriesDescription:
      "我们为初创企业、中小企业、大型企业、政府机构、教育机构、医院以及多个行业的企业构建数字产品。",
    ...
    industries: [
      {
        ...
        icon: "🏥",
        description:
          "医院管理、远程医疗、药房、患者管理和医疗保健解决方案。",
      },
      {
        title: "教育",
        icon: "🎓",
        description:
          "学校 ERP、LMS、在线学习、学生管理和考试系统。",
      },
      {
        title: "零售与电子商务",
        icon: "🛒",
        description:
          "在线商店、Marketplace、POS 系统、库存和支付解决方案。",
      },
      {
        title: "金融",
        icon: "💳",
        description:
          "数字钱包、银行应用、支付网关和金融科技应用。",
      },
      {
        title: "酒店与餐饮",
        icon: "🏨",
        description:
          "酒店预订、度假村管理、餐厅点餐和旅游平台。",
      },
      {
        title: "交通运输",
        icon: "🚖",
        description:
          "出租车预订、物流、快递跟踪和车队管理解决方案。",
      },
      {
        title: "房地产",
        icon: "🏠",
        description:
          "房产列表、经纪人管理和房地产 CRM 解决方案。",
      },
      {
        title: "制造业",
        icon: "🏭",
      ...
      },
      {
        ...
        icon: "🎬",
        description:
          "音乐流媒体、OTT 平台、游戏和社交网络应用。",
      },
      {
        title: "初创企业",
        icon: "🚀",
        description:
          "快速 MVP 开发、可扩展架构和面向投资者的应用程序。",
      },
      {
        title: "农业",
        icon: "🌾",
      ...
      },
      {
        ...
        icon: "🏢",
        description:
          "定制 ERP、CRM、HRMS、工作流程自动化和商业智能解决方案。",
      },
    ],
    ...
    technologiesTitle: "我们使用的技术",

    technologiesDescription:
      "我们的开发人员采用现代技术和行业最佳实践，为初创企业、企业和大型组织构建安全、高性能且可扩展的移动应用程序。",
    ...
    whyUsDescription:
      "我们结合创新技术、现代设计理念和行业经验，为企业提供可靠的移动应用，帮助企业更快实现增长。",
    ...
    whyUs: [
      {
        ...
        icon: "📱",
        description:
          "每个应用程序都根据您的业务目标、目标受众和运营需求进行专门设计。",
      },
      {
        title: "可扩展架构",
        icon: "🚀",
        description:
          "应用程序在设计时充分考虑未来增长，使您的平台能够随着业务扩展而持续扩展。",
      },
      {
        title: "现代 UI/UX",
        icon: "🎨",
        description:
          "美观、直观且响应式的用户界面，提高用户参与度和满意度。",
      },
      {
        title: "高性能",
        icon: "⚡",
        description:
          "经过优化的代码和高效架构确保应用程序在所有受支持设备上流畅运行。",
      },
      {
        title: "安全开发",
        icon: "🔒",
        description:
          "采用行业标准安全实践，包括身份验证、加密和安全 API 集成。",
      },
      {
        title: "API 集成",
        icon: "🔗",
        description:
          "无缝集成支付网关、地图、消息服务、CRM、ERP 和第三方平台。",
      },
      {
        title: "自托管部署",
        icon: "🖥️",
        description:
          "应用程序可以部署在您自己的 VPS 或专用服务器上，让您拥有完整的所有权和控制权。",
      },
      {
        title: "长期支持",
        icon: "🛠️",
        description:
          "提供持续维护、监控、功能增强、安全更新和技术支持。",
      },
    ],
    ...
    seoTitle: "专业移动应用开发解决方案",

    seoParagraphs: [
      "移动应用已经成为企业提高客户参与度、自动化流程和增加收入的重要工具。CH TECH GIANT 致力于创建创新的移动应用，为企业带来可衡量的业务成果。",

      "我们的开发团队使用 Flutter、Android、iOS、Firebase、Node.js 和云平台等最新技术，构建安全且可扩展的应用程序。每个项目都以性能、易用性和未来增长为核心进行设计。",

      "从医疗保健和教育到金融科技、物流、电子商务和企业解决方案，我们帮助组织利用移动技术保持在当今数字市场中的竞争力。",
    ],
    ...
    faq: [
      {
        question: "移动应用开发需要多少钱？",
        answer:
          "费用取决于所需的功能、复杂程度、平台和集成服务。我们会根据您的项目需求提供定制报价。",
      },
      {
        question: "你们同时开发 Android 和 iOS 应用吗？",
        answer:
          "是的。我们开发 Android 应用、iOS 应用以及 Flutter 跨平台应用。",
      },
      {
        question: "你们提供上线后的技术支持吗？",
        answer:
          "是的。我们提供上线后的维护、更新、监控、错误修复和功能增强服务。",
      },
    ],
    ...
    ctaTitle: "准备好打造您的应用了吗？",

    ctaDescription:
      "与 CH TECH GIANT 合作，将您的想法转化为强大的移动应用程序。",
    ...
    metaTitle:
      "移动应用开发公司 | Android、iOS 和 Flutter 应用 | CH TECH GIANT",

    metaDescription:
      "CH TECH GIANT 提供 Android 应用开发、iOS 应用开发、Flutter 应用开发、企业移动应用、UI/UX 设计和定制软件解决方案。",

    metaKeywords:
      "移动应用开发公司, Android 应用开发, iOS 应用开发, Flutter 应用开发, 定制移动应用, 企业应用开发",
  ...
  portfolio: {
    seo: {
      ...
      description:
        "探索由 CH TECH GIANT 开发的网站、移动应用、软件系统和数字项目。",
      keywords:
        "CH TECH GIANT 作品集, 网站开发项目, 移动应用项目, 软件项目, 应用开发作品集, 软件开发作品集",
    },
    ...
    description:
      "探索由 CH TECH GIANT 打造的高品质网站、移动应用、软件系统和游戏开发项目。",
    ...
    projects: {
      ...
      schoolErp: {
        title: "学校 ERP 系统",
        description:
          "通过集中式智能管理平台，高效管理学生、教职员工、教学、考勤以及学校运营。",
      },

      hospitalManagementSystem: {
        title: "医院管理系统",
        description:
          "安全的基于角色的医院管理系统，通过统一仪表板管理科室、医生、工作人员、患者和医院行政事务。",
      },
...
privacyPolicy: {
  seo: {
    ...
    keywords:
      "CH TECH GIANT 隐私政策, 数据保护, 隐私, 个人信息, 数据安全",
  },
...
电话：+91 9980785020
...

    {
      title: "我们收集的信息",
      content: `
当您使用我们的网站或服务时，我们可能会收集个人信息和技术信息。
...
我们不会向第三方出售或出租您的个人信息。
...

    {
      title: "第三方服务",
      content: `
我们的网站可能包含来自第三方平台的内容或集成功能，包括：
• YouTube
• Google服务
• 社交媒体平台
• 分析服务提供商

这些服务可能会根据其各自的隐私政策收集数据。
      `,
    },

    {
      title: "数据安全",
      content: `
CH TECH GIANT 采用符合行业标准的安全措施，以保护用户数据免受未经授权的访问、滥用、披露或破坏。

但是，任何在线平台或系统都无法保证绝对安全。
      `,
    },
...
info@chtechgiant.com
...

    {
      title: "外部链接",
      content: `
我们的网站可能包含指向外部网站的链接。对于第三方网站的隐私保护措施或内容，我们不承担责任。
      `,
    },
...
invoiceDesign: {
  ...
  bannerSubtitle:
    "为现代企业、初创公司和专业服务量身打造的高品质发票与账单设计。",
  ...
  introTitle: "智能发票设计解决方案",

  introParagraph1:
    "专业发票不仅仅是一份账单文件，也是企业品牌形象的重要组成部分。我们为您打造简洁、现代且专业的发票设计，让账单信息更加清晰易懂，同时展现企业独特的品牌形象。",

  introParagraph2:
    "无论您需要 GST 发票、服务发票、企业发票、报价单、估算单还是定制账单文件，我们都可以根据您的业务需求设计合适的布局。",
  ...
  whyTitle: "为什么专业的发票设计很重要",

  whyDescription:
    "发票是客户购买您的产品或服务后接触到的重要文件之一。设计良好的发票可以提高可读性、建立客户信任，并为您的企业打造统一且专业的品牌形象。",
  ...
  galleryBadge: "我们的发票设计",

  galleryTitle: "发票设计展示",

  galleryDescription:
    "探索我们为不同企业需求、行业和品牌风格打造的专业发票布局设计。",
  ...
  featuresTitle: "您的发票所需的一切",

  featuresDescription:
    "我们将专业的视觉设计与实际账单需求相结合，为您的企业打造实用且具有专业形象的发票布局。",
  ...
  features: [
    {
      ...
      description:
        "根据您的企业 Logo、品牌颜色、字体以及整体视觉识别系统设计与品牌一致的发票。",
    },

    {
      ...
      description:
        "创建清晰的发票布局，将 GST、税费、小计、折扣和总金额等信息进行合理组织。",
    },
...

    {
      ...
      description:
        "每个部分都经过合理规划，让客户能够快速理解产品、服务以及付款信息。",
    },
  ],
  ...
  processTitle: "我们如何制作您的发票",

  processDescription:
    "从了解您的需求到交付最终设计，我们遵循简单而系统的发票设计流程。",
  ...
  process: [
    {
      ...
      description:
        "我们了解您的业务、账单需求、产品或服务，以及发票中需要包含的信息。",
    },

    {
      ...
      description:
        "我们的设计师为客户信息、产品、税费、总金额和付款信息创建清晰有序的发票结构。",
    },

    {
      ...
      description:
        "将您的 Logo、品牌颜色、字体和品牌视觉识别系统专业地融入发票设计中。",
    },

    {
      ...
      description:
        "完成最终确认后，我们将以适合数字使用和专业打印的格式提供完整的发票设计。",
    },
  ],
  ...
  ctaDescription:
    "通过符合您业务需求的简洁、品牌化且易于使用的发票设计，为您的企业打造更加专业的形象。",

  ctaButton: "立即开始",
},
itConsulting: {
  seo: {
    title: "IT 咨询 | CH TECH GIANT",
    description:
      "提供专业的 IT 咨询服务，帮助企业优化技术战略、升级基础设施、实现业务自动化，并构建可扩展的数字化解决方案。",
    keywords:
      "IT 咨询, 技术咨询, IT 战略, 云咨询, 数字化转型, 业务自动化, 基础设施规划, 技术支持",
  },

  bannerTitle: "IT 咨询",

  bannerSubtitle:
    "提供专业的技术咨询服务，帮助企业实现业务增长、技术现代化和运营优化。",
  ...
  introDescription:
    "我们帮助初创企业、组织和企业选择合适的技术、优化工作流程，并构建可扩展的数字化生态系统。",
...
gameDevelopment: {
  seo: {
    title:
      "游戏开发公司 | 移动、2D 和 3D 游戏开发 | CH TECH GIANT",

    description:
      "CH TECH GIANT 提供专业的游戏开发服务，包括移动游戏、2D 和 3D 游戏、Unity、Unreal Engine、多人游戏、AR 和 VR 游戏，以及定制游戏开发解决方案。",

    keywords:
      "游戏开发公司, 游戏开发, 游戏开发服务, 移动游戏开发, 2D游戏开发, 3D游戏开发, Unity游戏开发, Unreal Engine开发, 多人游戏开发, AR VR游戏开发, 定制游戏开发",
  },

  bannerTitle: "游戏开发服务",

  bannerSubtitle:
    "为移动端、PC、多人游戏和跨平台游戏体验提供专业的游戏开发服务。",
  ...
  introDescription:
    "CH TECH GIANT 为初创企业、企业、教育机构和游戏行业公司提供专业的游戏开发服务。我们开发具有吸引力、可扩展且视觉效果出色的游戏，为不同平台上的玩家提供流畅且令人印象深刻的游戏体验。我们的开发能力涵盖移动游戏、Unity 项目、Unreal Engine 开发、多人游戏、教育游戏、模拟游戏、休闲游戏以及定制游戏解决方案。从最初的游戏创意和原型设计，到开发、测试、发布和持续技术支持，我们帮助客户将游戏创意转化为高质量、可投入市场的游戏产品。",
  ...
  servicesDescription:
    "我们提供从游戏概念、设计、原型开发、程序开发、测试，到发布、变现和持续技术支持的一站式游戏开发服务。",
  ...
  serviceDetails: [
    {
      ...
      description:
        "为 Android 和 iOS 开发具有吸引力的移动游戏，支持直观的操作方式、性能优化、流畅的游戏体验、云服务集成、排行榜、成就系统以及游戏变现功能。",
    },

    {
      ...
      description:
        "开发支持实时网络通信、匹配系统、玩家同步、聊天功能、排行榜、用户账户和可扩展后端基础设施的在线多人游戏。",
    },

    {
      ...
      description:
        "开发具有精细游戏环境、真实物理效果、角色动画、交互式游戏系统、优化图形和流畅渲染性能的沉浸式 3D 游戏。",
    },

    {
      ...
      description:
        "为娱乐、教育、模拟、培训、营销和沉浸式数字应用开发交互式增强现实（AR）和虚拟现实（VR）游戏体验。",
    },
  ],
  ...
  processDescription:
    "通过结构化的开发流程，我们帮助客户将游戏创意逐步转化为稳定、具有吸引力并适合市场发布的游戏产品。",
  ...
  seoContent: [
    "我们的定制游戏开发服务帮助初创企业、企业、教育机构和游戏公司打造具有吸引力的互动数字体验。我们可以开发动作游戏、益智游戏、策略游戏、教育游戏、模拟游戏、赛车游戏、冒险游戏、多人游戏以及其他定制游戏解决方案。",

    "通过结合创意游戏设计、现代编程技术、游戏引擎、后端基础设施和性能优化，我们开发能够提供流畅游戏体验并支持长期业务发展的游戏产品。",

    "我们的游戏解决方案可应用于娱乐、教育、营销、员工培训、模拟训练、客户互动以及其他互动场景。每个项目都会根据目标用户、游戏玩法需求、目标平台和具体业务目标进行规划和开发。",
  ],
  ...
  ctaDescription:
    "正在寻找专业的游戏开发公司？欢迎联系 CH TECH GIANT，讨论您的移动游戏、多人游戏、Unity 项目、Unreal Engine 项目或定制游戏开发需求。",
