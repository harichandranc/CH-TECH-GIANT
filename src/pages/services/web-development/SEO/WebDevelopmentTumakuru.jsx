...
const faqData = [
  {
    question: "How much does website development cost in Tumakuru?",
    answer:
...
const WebDevelopmentTumakuru = () => {
  const schemaData = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "CH TECH GIANT (OPC) PRIVATE LIMITED",
    description:
      "Web Development Company in Tumakuru providing website development, e-commerce development, MERN stack development, software development and app development services.",
  ...
  return (
    <>
      <Helmet>
        <title>
          Web Development Company in Tumakuru | Website Development
        ...
        <meta
          name="keywords"
          content="Web Development Company Tumakuru, Website Development Tumakuru, Website Developers Tumakuru, Web Design Company Tumakuru, Web Development Karnataka, React Development Company, MERN Stack Development, Website Development Services Karnataka"
        />
      ...
      <div className="bg-[#050816] text-white">
        <PageBanner
          title="Web Development Company in Karnataka serving Tumakuru"
        ...
        <SectionWrapper>
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-4xl mx-auto">
              ...
              for businesses across Tumakuru, Karnataka, and India.
            </p>
          </div>
        ...
        <SectionWrapper>
          <div className="bg-white/5 border border-cyan-500/10 rounded-3xl p-10">
            <h2 className="text-4xl font-bold mb-6">
              Professional Website Development Services in Tumakuru
            </h2>
            ...
            <div className="space-y-6 text-gray-400 leading-relaxed">
              ...
              <p>
                We serve businesses across Tumakuru including retail
        ...
        <SectionWrapper>
          <div className="bg-white/5 border border-cyan-500/10 rounded-3xl p-10">
            ...
            <p className="text-gray-400 leading-relaxed mb-5">
              ...
              Tumakuru and surrounding regions across Karnataka.
            </p>
...
export default WebDevelopmentTumakuru;