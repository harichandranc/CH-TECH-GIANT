...
const faqData = [
  {
    question: "How much does website development cost in Davanagere?",
    answer:
...
const WebDevelopmentDharwad = () => {
  const schemaData = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "CH TECH GIANT (OPC) PRIVATE LIMITED",
    description:
      "Web Development Company in Dharwad providing website development, e-commerce development, MERN stack development, software development and app development services.",
  ...
  return (
    <>
      <Helmet>
        <title>
          Web Development Company in Dharwad | Website Development
        ...
        <meta
          name="keywords"
          content="Web Development Company Dharwad, Website Development Dharwad, Website Developers Dharwad, Web Design Company Dharwad, Web Development Karnataka, React Development Company, MERN Stack Development, Website Development Services Karnataka"
        />
      ...
      <div className="bg-[#050816] text-white">
        <PageBanner
          title="Web Development Company in Dharwad"
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            >
              <h2 className="text-4xl font-bold mb-6">
                Leading Web Development Company in Karnataka, Serving Dharwad and Beyond
                Karnataka
              </h2>
        ...
        <SectionWrapper>
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-4xl mx-auto">
              ...
              for businesses across Dharwad, Karnataka, and India.
            </p>
          </div>
        ...
        <SectionWrapper>
          <div className="bg-white/5 border border-cyan-500/10 rounded-3xl p-10">
            <h2 className="text-4xl font-bold mb-6">
              Professional Website Development Services in Dharwad
            </h2>
            ...
            <div className="space-y-6 text-gray-400 leading-relaxed">
              ...
              <p>
                We serve businesses across Dharwad including retail
        ...
        <SectionWrapper>
          <div className="bg-white/5 border border-cyan-500/10 rounded-3xl p-10">
            ...
            <p className="text-gray-400 leading-relaxed mb-5">
              ...
              Dharwad and surrounding regions across Karnataka.
            </p>
...
export default WebDevelopmentDharwad;