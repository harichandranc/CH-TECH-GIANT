...
const WebDevelopmentBangalore = () => {
  const schemaData = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "CH TECH GIANT (OPC) PRIVATE LIMITED",
    description:
      "Web Development Company in Bangalore providing website development, e-commerce development, MERN stack development, software development and app development services.",
  ...
  return (
    <>
      <Helmet>
        <title>
          Web Development Company in Bangalore | Website Development
          Services Karnataka | CH TECH GIANT
        </title>

        <meta
          name="description"
          content="CH TECH GIANT is a leading web development company in Bangalore, Karnataka. We provide website development, custom web applications, e-commerce development, MERN stack solutions, React development, and SEO-friendly websites."
        />

        <meta
          name="keywords"
          content="Web Development Company Bangalore, Website Development Bangalore, Website Developers Bangalore, Web Design Company Bangalore, Web Development Karnataka, React Development Company, MERN Stack Development, Website Development Services Karnataka"
        />
        ...
        <SectionWrapper>
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-4xl mx-auto">
              ...
              for businesses across Bangalore, Karnataka, and India.
            </p>
          </div>
        ...
        <SectionWrapper>
          <div className="bg-white/5 border border-cyan-500/10 rounded-3xl p-10">
            ...
            <div className="space-y-6 text-gray-400 leading-relaxed">
              ...
              <p>
                We serve businesses across Bangalore including retail
        ...
        <SectionWrapper>
          <div className="bg-white/5 border border-cyan-500/10 rounded-3xl p-10">
            ...
            <p className="text-gray-400 leading-relaxed mb-5">
              ...
              Bangalore and surrounding regions.
            </p>
...
export default WebDevelopmentBangalore;